...
function exportTable() {
    jQuery(function ($) {
        $("#mainTableGb").table2excel({
            exclude: ".noExl",

            name: "Worksheet Name",

            filename: "Concursantes",
...
function test(){
    jQuery(function ($) {
             if(window.matchMedia("(max-width: 960px)").matches){ 
                $("#cedulaLogin").focus(function(){
                        $('.third').hide();
                    });
                $("#cedulaLogin").focusout(function(){
                        $('.third').show();
                    });
    }
    })
...
jQuery(function ($) {
    $(document).ready(function () {
        ...
        $('.citiesData').click(function (e) {
           var city =  e.target;
           if (selectedCity !== null){
            $(selectedCity).toggleClass('active');
           }
