...
akeeba.Fsfilters.load=function(a){a.verb="list";a=JSON.stringify(a);var b={};b.akaction=a;akeeba.System.doAjax(b,function(d){akeeba.Fsfilters.render(d)},null,!1,15E3)};
...
(akeeba.System.removeClass(e,"akion-android-star-outline"),akeeba.System.addClass(e,"akion-android-star")):-1!=e.className.indexOf("akion-android-star")&&(akeeba.System.addClass(e,"akion-android-star-outline"),akeeba.System.removeClass(e,"akion-android-star"))},250);akeeba.System.data.set(b,"akeebatimer",g)}var c={akaction:JSON.stringify(a)};akeeba.System.doAjax(c,function(k){if(null!=b){var h=akeeba.System.data.get(b,"akeebatimer");clearInterval(h);if(h=akeeba.System.data.get(b,"iconClass"))e.className=
...
uielement.appendChild(c);h.appendChild(uielement)}};akeeba.Fsfilters.nuke=function(){var a={akaction:JSON.stringify({root:akeeba.Fsfilters.currentRoot,verb:"reset"})};akeeba.System.doAjax(a,function(b){akeeba.Fsfilters.render(b)},null,!1,15E3)};akeeba.Fsfilters.loadTab=function(a){a={akaction:JSON.stringify({verb:"tab",root:a})};akeeba.System.doAjax(a,function(b){akeeba.Fsfilters.renderTab(b)},null,!1,15E3)};
...
return!1}))}); //# sourceMappingURL=fsfilters.min.map
