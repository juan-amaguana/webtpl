...
akeeba.Wizard.maxExecApply=function(a){akeeba.Backup.resetTimeoutBar();akeeba.Backup.startTimeoutBar(1E4,100);document.getElementById("backup-substep").textContent=akeeba.System.Text._("COM_AKEEBA_CONFWIZ_UI_SAVINGMAXEXEC");akeeba.System.doAjax({akact:"applymaxexec",seconds:a},function(){document.getElementById("step-maxexec").className="akeeba-label--green";akeeba.Wizard.partSize()},function(){document.getElementById("backup-progress-pane").style.display="none";document.getElementById("error-panel").style.display=
...
akeeba.System.Text._("COM_AKEEBA_CONFWIZ_UI_PARTSIZE").replace("%s",b.toFixed(3));document.getElementById("step-splitsize").className="akeeba-label--teal";akeeba.System.doAjax({akact:"partsize",blocks:a},function(c){c?(document.getElementById("step-splitsize").className="akeeba-label--green",akeeba.Wizard.done()):akeeba.Wizard.partSize()},function(c){akeeba.Wizard.partSize()},!1,6E4)}};
...
akeeba.Wizard.autodetect=function(a){a={akact:"pythia",folder:a};document.getElementById("varakeeba.advanced.embedded_installer").value="angie-generic";akeeba.System.doAjax(a,function(b){if("object"===typeof b){var c=b.database.driver;document.getElementById("varakeeba.platform.scripttype").value=b.cms;document.getElementById("varakeeba.advanced.embedded_installer").value=b.installer;document.getElementById("var[akeeba.platform.dbdriver]").value=c;document.getElementById("var[akeeba.platform.dbhost]").value=
b.database.host;document.getElementById("var[akeeba.platform.dbport]").value=b.database.port;document.getElementById("var[akeeba.platform.dbusername]").value=b.database.username;document.getElementById("var[akeeba.platform.dbpassword]").value=b.database.password;document.getElementById("var[akeeba.platform.dbname]").value=b.database.name;document.getElementById("var[akeeba.platform.dbprefix]").value=b.database.prefix;document.getElementById("pythiaExtradirs").innerHTML=b.extradirs.join("<br/>");c=
[];for(var d,f=0;f<b.extradb.length;f++){var e=b.extradb[f];d="<strong>Host</strong>: "+e.host;d+=" <strong>Db</strong>: "+e.name;d+=" <strong>User</strong>: "+e.username;d+=" <strong>Prefix</strong>: "+e.prefix;c.push(d)}document.getElementById("pythiaExtradb").innerHTML=c.join("<br/>");akeeba.System.triggerEvent(document.querySelector('select[id*="akeeba.platform.dbdriver"]'),"change")}});return!1};
