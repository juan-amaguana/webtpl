...
akeeba.Dbfilters.load=function(a){a.verb="list";a={akaction:JSON.stringify(a)};akeeba.System.doAjax(a,function(c){akeeba.Dbfilters.render(c)},null,!1,15E3)};akeeba.Dbfilters.toggle=function(a,c,d){akeeba.Fsfilters.toggle(a,c,d)};
...
g.setAttribute("title",akeeba.System.Text._(b));b=document.createElement("span");b.className=h;g.appendChild(b);e.className="table-icon-container table-icon-noclick table-icon-small";h=document.createElement("span");h.className="akion-android-more-vertical";h.style.color="#cccccc";e.appendChild(h);k.appendChild(e);k.appendChild(g);k.appendChild(m);k.appendChild(f);c.appendChild(k)}};
akeeba.Dbfilters.loadTab=function(a){a={akaction:JSON.stringify({verb:"tab",root:a})};akeeba.System.doAjax(a,function(c){akeeba.Dbfilters.renderTab(c)},null,!1,15E3)};
...
akeeba.Dbfilters.nuke=function(){var a={akaction:JSON.stringify({root:akeeba.Dbfilters.currentRoot,verb:"reset"})};akeeba.System.doAjax(a,function(c){akeeba.Dbfilters.render(c)},null,!1,15E3)};
akeeba.System.documentReady(function(){var a=akeeba.System.getOptions("akeeba.DatabaseFilters.guiData",null);"list"===akeeba.System.getOptions("akeeba.DatabaseFilters.viewType",null)?(akeeba.System.addEventListener("active_root","change",akeeba.Dbfilters.activeRootChanged),akeeba.Dbfilters.render(a)):(akeeba.System.addEventListener("active_root","change",akeeba.Dbfilters.activeTabRootChanged),akeeba.Dbfilters.renderTab(a));akeeba.System.addEventListener("comAkeebaDatabaseFiltersExcludeNonCMS","click",
function(){akeeba.Dbfilters.excludeNonCMS();return!1});akeeba.System.addEventListener("comAkeebaDatabaseFiltersNuke","click",function(){akeeba.Dbfilters.nuke();return!1});akeeba.System.addEventListener("comAkeebaDatabaseFiltersAddNewTables","click",function(){akeeba.Dbfilters.addNew("tables");return!1});akeeba.System.addEventListener("comAkeebaDatabaseFiltersAddNewTableData","click",function(){akeeba.Dbfilters.addNew("tabledata");return!1})}); //# sourceMappingURL=dbfilters.min.map
