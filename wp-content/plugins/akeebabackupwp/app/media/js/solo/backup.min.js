...
akeeba.Backup.endWithError=function(a){akeeba.Backup.resetTimeoutBar();var b=!1;document.getElementById("backup-progress-pane").style.display="none";document.getElementById("backup-warnings-panel").style.display="none";document.getElementById("retry-panel").style.display="none";var c=akeeba.System.getOptions("akeeba.Backup.URLs.LogURL"),e=akeeba.System.getOptions("akeeba.Backup.URLs.AliceURL");c=c+"&tag="+akeeba.Backup.tag;var d=e+"&log="+akeeba.Backup.tag;akeeba.Backup.backupid&&(c=c+"."+encodeURIComponent(akeeba.Backup.backupid),
d=d+"."+encodeURIComponent(akeeba.Backup.backupid));"finale"==akeeba.Backup.currentDomain&&(b=!0,d+="&autorun=1");document.getElementById("ab-viewlog-error").setAttribute("href",c);document.getElementById("ab-alice-error").setAttribute("href",d);akeeba.System.notification.notify(akeeba.System.Text._("COM_AKEEBA_BACKUP_TEXT_BACKUPFAILED"),a);akeeba.System.doAjax({ajax:"pushFail",tag:akeeba.Backup.tag,backupid:akeeba.Backup.backupid,errorMessage:a},function(f){});document.getElementById("backup-error-message").textContent=
...
akeeba.Backup.backupid&&(b=b+"."+encodeURIComponent(akeeba.Backup.backupid)):b=a+"&latest=1";try{document.getElementById("ab-viewlog-success").setAttribute("href",b)}catch(c){}akeeba.System.getOptions("akeeba.Backup.returnForm",!1)?document.getElementById("returnForm").submit():(a=akeeba.System.getOptions("akeeba.Backup.returnUrl",""),""!==a&&(window.location=a))};
